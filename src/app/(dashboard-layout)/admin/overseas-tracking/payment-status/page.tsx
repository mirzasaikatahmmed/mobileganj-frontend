...
const mockPayments = [
  { id: 'SHP-001', payee: 'Dubai Tech Hub', type: 'Shop/Supplier', totalAmount: 1250000, paidAmount: 800000, dueAmount: 450000, status: 'Partial' },
  { id: 'SHP-001', payee: 'Karim Carrier', type: 'Carrier', totalAmount: 15000, paidAmount: 5000, dueAmount: 10000, status: 'Partial' },
  { id: 'SHP-002', payee: 'Singapore Mobile', type: 'Shop/Supplier', totalAmount: 850000, paidAmount: 0, dueAmount: 850000, status: 'Pending' },
];
  ...
  return (
    <div className="space-y-4 sm:space-y-6 px-2 sm:px-0">
      <div>
        ...
        <p className="text-muted-foreground text-sm sm:text-base">Track supplier and carrier payments</p>
      </div>
      ...
      <div className="relative">
        ...
        <Input
          placeholder="Search by shipment ID or payee..."
          value={search}
          ...
          <table className="w-full">
            <thead className="bg-muted/50">
              <tr>
                ...
                <th className="text-left p-3 sm:p-4 font-semibold text-sm">Payee</th>
            ...
            <tbody>
              {mockPayments.map((payment, index) => (
                <tr key={`${payment.id}-${index}`} className="border-t hover:bg-muted/50">
